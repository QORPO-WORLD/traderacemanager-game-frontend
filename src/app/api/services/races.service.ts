...
class RacesService extends __BaseService {
  ...
  binaryPlayersResponse(raceHash: string): __Observable<__StrictHttpResponse<Array<any>>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/races/versus/${raceHash}/players`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  binaryPlayers(raceHash: string): __Observable<Array<any>> {
    return this.binaryPlayersResponse(raceHash).pipe(
      __map(_r => _r.body as Array<any>)
    );
  }
  binaryHistoryResponse(raceHash: number): __Observable<__StrictHttpResponse<Array<any>>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/races/versus/history/${raceHash}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  binaryHistory(raceHash: number): __Observable<Array<any>> {
    return this.binaryHistoryResponse(raceHash).pipe(
      __map(_r => _r.body as Array<any>)
    );
  }

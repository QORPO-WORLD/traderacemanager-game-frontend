...
@Component({
  selector: 'app-ioi-tokens',
  templateUrl: './ioi-tokens.component.html',
  styleUrls: ['./ioi-tokens.component.scss']
})
export class IoiTokensComponent implements OnInit, OnDestroy {
  buying = 0;
  ...
  getMyBalance() {
    this.myBalance = this.identityService.getBalance();

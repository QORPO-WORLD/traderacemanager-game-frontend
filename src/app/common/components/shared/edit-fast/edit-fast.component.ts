...
@Component({
  selector: 'app-edit-fast',
  templateUrl: './edit-fast.component.html',
  styleUrls: ['./edit-fast.component.scss']
})
export class EditFastFuelCarComponent implements OnInit, OnDestroy {
  myCars: any;
  @Input() myCar: number;
  @Input() magic: any;
  ...
  signupToRace() {
    ...
    this.notify.error('', 'Favourite fuel updated successfully');
    this.router.navigate(['/other/loading']);

...
class TeamsService extends __BaseService {
  ...
  getTeamHistoryResponse(): __Observable<__StrictHttpResponse<any>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + '/races/team/history/turnover',
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return Returns the team id you're a member of.
   */
  getTeamHistory(): __Observable<any> {
    return this.getTeamHistoryResponse().pipe(
      __map(_r => _r.body as any)
    );
  }
  getTeamHistoryPointsResponse(): __Observable<__StrictHttpResponse<any>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + '/races/team/history/points',
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return Returns the team id you're a member of.
   */
  getTeamHistoryPoints(): __Observable<any> {
    return this.getTeamHistoryPointsResponse().pipe(
      __map(_r => _r.body as any)
    );
  }
  ...
  rateManagerResponse(data: any): __Observable<__StrictHttpResponse<any>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = data;
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + '/races/team/rate-manager',
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return Returns the team id you're a member of.
   */
   rateManager(data: any): __Observable<any> {
    return this.rateManagerResponse(data).pipe(
      __map(_r => _r.body as any)
    );
  }
